...
**Maintained by TYR-X | Version 1.4 | March 2026**
...
The OWASP Top 10 for LLM Applications 2025 is the most widely referenced standard for LLM application security risks. All ten entries have a configuration-layer dimension. The VSF covers that dimension across all ten.

The mapping is in [VSF.md](/VSF.md) with precise scope declarations for each entry — including explicit statements of where the VSF's configuration-layer scope ends and where model-layer or infrastructure-layer tooling begins.
...
**Security practitioners** who want the full technical definitions, OWASP 2025 mapping, and scope declarations — see [VSF.md](/VSF.md).
...
*For the full technical taxonomy with precise definitions, OWASP 2025 alignment, and scope declarations: [VSF.md](/VSF.md)*
